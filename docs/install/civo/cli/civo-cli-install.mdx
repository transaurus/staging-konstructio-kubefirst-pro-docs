---
title: Civo CLI Install
description: Installation details for Kubefirst Pro with Civo and the CLI
...
After reviewing and confirming you have all of the prerequisites required for this installation process this page walks through all of the steps for **Kubefirst installation with Civo and the CLI**.

## Installing Kubefirst

To get started with this installation you will need to have your git token (for GitHub or GitLab) and your Civo API Key. By default, Kubefirst assumes you will use Civo to manage DNS, to use Cloudflare use the tip below.
...
Run the following command for GitLab (updated with your values). Note that Kubefirst uses your Cloud Provider (Civo) to manage DNS but you can also use Cloudflare.  
...
Run the following command For GitHub (updated with your values). Note that Kubefirst uses your Cloud Provider (Civo) to manage DNS but you can also use Cloudflare.  
...
2. After about 10 minutes, your browser will launch a new tab for the Kubefirst UI, which will help you navigate your new suite of tools running in your new Civo cluster.
