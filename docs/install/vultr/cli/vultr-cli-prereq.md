---
title: Vultr CLI Prerequisites
description: Prerequisites for installation of Kubefirst with Vultr and the CLI
keywords: [vultr, prerequisites, requirements, kubernetes, containers, clusters, kubefirst, konstruct]
sidebar_position: 2
---

## Summary

This document walks through the prerequisites for installing **Kubefirst using Vultr with the Kubefirst CLI**.
