---
title: Google UI Install
description: Installation steps for Kubefirst using Google Cloud and the UI
keywords: [google cloud, install, installation, setup, provisioning, kubernetes, containers, clusters, kubefirst, konstruct]
sidebar_position: 2
---

## Summary

After reviewing and confirming you have all of the prerequisites required for this installation process this page walks through all of the steps for **Kubefirst installation with Google Cloud and the Kubefirst UI**.
...
2. Provide the required details for your Git provider.
    ...
    - Google Cloud key file (JSON)
  
    ![Authentication](../../../img/google/googleuiauth.png)
...
Note: the recommendations below are the minimum requirements to run a management cluster.
   ...
   - Cloud region - us-east2 (recommended)
   - Cloud zone - us-east2-b (recommended)
   ...
   - Cluster name - management (or something similar)
    ...
    ![Cluster details](../../../img/google/googleclusterdetails.png)
...
6. Select **Create Cluster** once you’re satisfied with the details you’ve provided to start provisioning! _This process is typically about 15-20 minutes._
    ...
    ![Provisioning](../../../img/google/googleprovisioning.png)
