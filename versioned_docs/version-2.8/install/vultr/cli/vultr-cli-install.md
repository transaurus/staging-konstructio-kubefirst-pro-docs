---
title: Vultr CLI Install
description: Installation steps for Kubefirst with Vultr and the CLI
keywords: [install, installation, setup, provisioning, vultr, kubernetes, containers, clusters, kubefirst, konstruct]
sidebar_position: 3
---
...
To get started with this installation you will need to have your git token (for GitHub or GitLab) and the credentials associated with your Vultr account.
