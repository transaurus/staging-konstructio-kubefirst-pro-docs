---
title: Akamai UI Install
description: Installation steps for Kubefirst using Akamai and the UI
keywords: [akamai, install, installation, setup, provisioning, kubernetes, containers, clusters, kubefirst, konstruct]
sidebar_position: 2
---
