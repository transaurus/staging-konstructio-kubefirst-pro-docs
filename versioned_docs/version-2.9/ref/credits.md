...
keywords: [tools, credits, open source, thanks, kubernetes, containers, clusters, kubefirst, konstruct] 
sidebar_position: 4
---

## The Tools We Love

Kubefirst uses some of the most popular open source projects in the world, and some closed sources ones (as little as possible). This page is dedicated to those projects to give them credit for their incredible offerings and to say thanks!
...
- [Crossplane](https://github.com/crossplane/crossplane) ([Apache 2.0](https://github.com/crossplane/crossplane/blob/master/LICENSE))
...
:::note
For compliance purposes, we strongly recommended that you evaluate each license for third-party tools and software used by Konstruct. You are responsible for verifying that these tools are compliant with any of your personal or organizational requirements.
:::
